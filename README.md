...
* [MetaConfigurator](https://www.metaconfigurator.org) - Has in-built AI-assistance to [generate RML mappings via LLM](https://github.com/MetaConfigurator/meta-configurator/tree/develop/documentation_user/examples/rdf) based on user hints in natural language.
